...
public class FenetrePrincipale extends JFrame
{
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						Class.forName("com.mysql.jdbc.Driver").newInstance ( ) ;
							...
							try {con = (Connection) DriverManager.getConnection ("jdbc:mysql://localhost/Scolarite", "root","vvvvv") ;
							}
		  ...
		  dialog2.setBounds(100, 100, 450, 500);
					 ...
					 try{
	                	 ...
	                	 try {
	         				Class.forName("com.mysql.jdbc.Driver").newInstance ( ) ;
	         					...
	         					try
	         					{
	         						con = (Connection) DriverManager.getConnection ("jdbc:mysql://localhost/Scolarite", "root","vvvv") ;
	         					}
	         					catch (Exception ez ){System.out.println("Erreur de connexion "+ ez.getMessage ( ));}
			...
			btnParcourirToutLe.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try
					{
						con =(Connection) DriverManager.getConnection ("jdbc:mysql://localhost/Bibliotheque","root","vvvv") ;
					}
					catch (Exception ez )
					{
	...
	public void lanceDialogEnXML( )
		  ...
		  try
			...
			try
			{
				con =(Connection) DriverManager.getConnection ("jdbc:mysql://localhost/Scolarite","root","VVVVV") ;
			}
			catch (Exception ez )
			{	System.out.println("Erreur de connexion "+ ez.getMessage ( ));	}
			try
		  ...
		  dialog4.setSize(600,900);
			...
			try {
				Class.forName("com.mysql.jdbc.Driver").newInstance ( ) ;
					...
					try
					{
						con = (Connection) DriverManager.getConnection ("jdbc:mysql://localhost/Bibliotheque", "root","VVVVV") ;
					}
					catch (Exception ez ){System.out.println("Erreur de connexion "+ ez.getMessage ( ));}
